...
var modifyUrls = function modifyUrls(filePath, fileContents, sourcemap) {
  ...
  return (0, _rework2.default)(fileContents, { source: filePath }).use((0, _reworkPluginUrl2.default)(function (url) {
    ...
    return formattedUrl;
  })).toString({ sourcemap: sourcemap, sourcemapAsObject: true });
};
...
module.exports = function (options) {
  return _through2.default.obj(function (file, enc, cb) {
    try {
      ...
      return cb(new _gulpUtil2.default.PluginError('modify-css-urls', e));
    }
  });
};